"""
Django settings for decapithlon project.
...
ALLOWED_HOSTS = ['https://decapithlon.herokuapp.com/']
...
WSGI_APPLICATION = 'decapithlon.wsgi.application'
